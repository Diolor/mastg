...
| --- | --- | --- |
| [`textNoSuggestions`](https://developer.android.com/reference/kotlin/android/widget/TextView#android:inputType:~:text=textNoSuggestions) | [`TYPE_TEXT_FLAG_NO_SUGGESTIONS`](https://developer.android.com/reference/kotlin/android/text/InputType.html#type_text_flag_no_suggestions. "Text input type") | 3 |
