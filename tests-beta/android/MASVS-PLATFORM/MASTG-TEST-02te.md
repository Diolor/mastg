...
In all the above cases, if specific storage areas are enabled but the cleanup methods are not called, sensitive data may be stored past the end of its intended lifetime.
