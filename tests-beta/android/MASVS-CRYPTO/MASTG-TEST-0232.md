...
1. Run @MASTG-TECH-0014 with a tool such as @MASTG-TOOL-0110 on the app code, or use @MASTG-TECH-0033 (dynamic analysis) with a tool like @MASTG-TOOL-0001, and look for cryptographic functions specifying the encryption mode to insecure modes.
