...
1. Run @MASTG-TECH-0014 with a tool such as @MASTG-TOOL-0110 on the app and look for insecure random APIs, or you can use @MASTG-TECH-0033 to detect the use of such APIs.
