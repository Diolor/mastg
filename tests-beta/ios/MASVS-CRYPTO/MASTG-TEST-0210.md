...
1. Use @MASTG-TECH-0066 on the app binary or use a dynamic analysis tool like @MASTG-TOOL-0039 to look for uses of the cryptographic functions that perform encryption and decryption operations.
