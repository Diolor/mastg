...
If server-side control is not possible or as a supplementary control, explicitly set [`WebSettings.setCacheMode()`](https://developer.android.com/reference/kotlin/android/webkit/WebSettings#setcachemode) with [`WebSettings.LOAD_NO_CACHE`](https://developer.android.com/reference/kotlin/android/webkit/WebSettings#load_no_cache) or clear the WebView cache with [`WebView.clearCache(includeDiskFiles = true)`](https://developer.android.com/reference/kotlin/android/webkit/WebView#clearcache) after WebView use (such as on WebView Activity's `onDestroy` lifecycle call) to reduce this risk. However, this method comes with two disadvantages:
